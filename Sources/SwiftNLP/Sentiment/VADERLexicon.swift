...
/// Provides static pre-sorted lookup structures holding the complete official VADER sentiment lexicon (7,520 words).
public enum VADERLexicon {
    /// Raw TSV payload of the complete official 7,520-word VADER sentiment lexicon.
    private static let rawLexiconData: String = """
$:	-1.5
%)	-0.4
%-)	-1.5
&-:	-0.4
...
"""
    ...
    /// Parsed lookup dictionary mapping words to valence scores.
    private static let lexiconDict: [String: Double] = {
        var dict = [String: Double]()
        dict.reserveCapacity(7550)
        let lines = rawLexiconData.components(separatedBy: "\n")
        for line in lines {
