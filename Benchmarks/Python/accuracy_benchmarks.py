...
def run_accuracy_benchmarks():
    ...
    if HAS_VADER:
        ...
        scores = sia.polarity_scores("SwiftSci 3.8.0 is incredibly fast and robust!")
...
def main():
    parser = argparse.ArgumentParser(description="SwiftSci Python Accuracy Benchmarks v3.8.0")
